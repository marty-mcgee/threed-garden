...
import MDPaginationItemRoot from '#/lib/mui/MDPagination/MDPaginationItemRoot'
...
const MDPagination: FC<Props | any> = forwardRef(({ item, variant, color, size, active, children, ...rest }, ref) => {
