...
import Billing from '#/ui/account/billing'
import Invoice from '#/ui/account/invoice'
import Timeline from '#/pages/projects/timeline'
import Pricing from '#/pages/pricing'
import Widgets from '#/pages/widgets'
import Charts from '#/pages/charts'
import Notifications from '#/pages/notifications'
import Kanban from '#/lib/components/applications/kanban'
import Wizard from '#/lib/components/applications/wizard'
import DataTables from '#/lib/components/applications/data-tables'
import Calendar from '#/lib/components/applications/calendar'
