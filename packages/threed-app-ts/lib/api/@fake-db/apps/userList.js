...
// POST: Add new user
mock.onPost('/modules/users/add-user').reply((config) => {
...
// GET: Updated DATA
mock.onGet('/modules/users/list').reply((config) => {
...
mock.onGet('/modules/user').reply((config) => {
...
// DELETE: Deletes User
mock.onDelete('/modules/users/delete').reply((config) => {
