...
// ------------------------------------------------
// GET: Return Emails
mock.onGet('/modules/email/allEmails').reply(() => {
  return [200, { emails: data.emails }]
})

// ------------------------------------------------
// GET: Return Emails
mock.onGet('/modules/email/emails').reply((config) => {
...
// ------------------------------------------------
mock.onPost('/modules/email/update-emails-label').reply((config) => {
...
// ------------------------------------------------
mock.onGet('/modules/email/get-email').reply((config) => {
...
// POST: Update Email
// ------------------------------------------------
mock.onPost('/modules/email/update-emails').reply((config) => {
...
// ------------------------------------------------
mock.onGet('/modules/email/paginate-email').reply((config) => {
