...
export const useThreeDStore = create((set, get, api) => ({
  ...
  increaseThreeDCount: () => set((state: any) => ({ threedCount: state.threedCount + 1 })),
  removeAllThreeDs: () =>
    set({
      threedCount: 0,
      threeds: [],
...
export const useProjectStore = create((set, get) => ({
  ...
  increaseProjectCount: () => set((state: any) => ({ projectCount: state.projectCount + 1 })),
  removeAllProjects: () =>
    set({
      projectCount: 0,
      projects: [],
...
export const usePlanStore = create((set, get) => ({
  ...
  increasePlanCount: () => set((state: any) => ({ planCount: state.planCount + 1 })),
  removeAllPlans: () =>
    set({
      planCount: 0,
      plans: [],
