...
// ** Tab Content Imports
import DialogTabDetails from '#/ui/views/pages/dialog-examples/create-app-tabs/DialogTabDetails'
import DialogTabBilling from '#/ui/views/pages/dialog-examples/create-app-tabs/DialogTabBilling'
import DialogTabDatabase from '#/ui/views/pages/dialog-examples/create-app-tabs/DialogTabDatabase'
import DialogTabFramework from '#/ui/views/pages/dialog-examples/create-app-tabs/DialogTabFramework'
