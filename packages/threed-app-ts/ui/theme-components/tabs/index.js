...
import TabsNav from '#/ui/views/components/tabs/TabsNav'
import TabsIcon from '#/ui/views/components/tabs/TabsIcon'
import TabsColor from '#/ui/views/components/tabs/TabsColor'
import TabsSimple from '#/ui/views/components/tabs/TabsSimple'
import TabsCentered from '#/ui/views/components/tabs/TabsCentered'
import TabsVertical from '#/ui/views/components/tabs/TabsVertical'
import TabsFullWidth from '#/ui/views/components/tabs/TabsFullWidth'
import TabsCustomized from '#/ui/views/components/tabs/TabsCustomized'
import TabsForcedScroll from '#/ui/views/components/tabs/TabsForcedScroll'
import TabsCustomizedVertical from '#/ui/views/components/tabs/TabsCustomizedVertical'

// ** Source code imports
import * as source from '#/ui/views/components/tabs/TabsSourceCode'
