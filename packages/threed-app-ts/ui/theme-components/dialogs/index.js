...
import DialogForm from '#/ui/views/components/dialogs/DialogForm'
import DialogAlert from '#/ui/views/components/dialogs/DialogAlert'
import DialogSizes from '#/ui/views/components/dialogs/DialogSizes'
import DialogSimple from '#/ui/views/components/dialogs/DialogSimple'
import DialogsScroll from '#/ui/views/components/dialogs/DialogsScroll'
import DialogTransition from '#/ui/views/components/dialogs/DialogTransition'
import DialogCustomized from '#/ui/views/components/dialogs/DialogCustomized'
import DialogFullScreen from '#/ui/views/components/dialogs/DialogFullScreen'
import DialogConfirmation from '#/ui/views/components/dialogs/DialogConfirmation'
import DialogRespoFullScreen from '#/ui/views/components/dialogs/DialogRespoFullScreen'

// ** Source code imports
import * as source from '#/ui/views/components/dialogs/DialogSourceCode'
