...
import PaginationSizes from '#/ui/views/components/pagination/PaginationSizes'
import PaginationSimple from '#/ui/views/components/pagination/PaginationSimple'
import PaginationRanges from '#/ui/views/components/pagination/PaginationRanges'
import PaginationRounded from '#/ui/views/components/pagination/PaginationRounded'
import PaginationButtons from '#/ui/views/components/pagination/PaginationButtons'
import PaginationOutlined from '#/ui/views/components/pagination/PaginationOutlined'
import PaginationDisabled from '#/ui/views/components/pagination/PaginationDisabled'
import PaginationControlled from '#/ui/views/components/pagination/PaginationControlled'

// ** Source code imports
import * as source from '#/ui/views/components/pagination/PaginationSourceCode'
