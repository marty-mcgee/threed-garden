...
function generateShareLink() {
  try {
    createThumbForHistory(),
      $.ajax({
        type: "POST",
        url: "https://homeidea3d.seanwasere.com/api/getsharelink",
        ...
        success: function (e) {
          console.log(e),
            ...
            (document.getElementById("shareLinkUrl").value =
              "https://threedgarde.com/demo/edit/" + shareLinkUrl),
            (document.getElementById("shareLinkUrl3d").value =
              "https://threedgarde.com/demo/3d/" + shareLinkUrl),
            (document.getElementById("shareLinkUrlPlan").value =
              "https://threedgarde.com/demo/plan/" + shareLinkUrl)
        },
        failure: function (e) {
