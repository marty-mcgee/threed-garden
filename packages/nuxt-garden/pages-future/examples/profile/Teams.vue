    ...
    <div class="mt-4 row">
      ...
      <div class="col-12 col-lg-4">
        <marketing-card
          ...
          :img3="team3"
          :img4="team4"
          img1-title="Alexa Tompson"
          img2-title="Romina Hadid"
          img3-title="Alexander Smith"
          img4-title="Martin Doe"
        >
        ...
        <marketing-card
          ...
          :img3="team1"
          :img4="team5"
          img1-title="Martin Doe"
          img2-title="Romina Hadid"
          img3-title="Alexa Tompson"
          img4-title="Alexandra Smith"
        >
