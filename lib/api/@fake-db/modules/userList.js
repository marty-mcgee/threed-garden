...
// POST: Add new user
mock.onPost('/api/modules/users/add-user').reply((config) => {
...
// GET: Updated DATA
mock.onGet('/api/modules/users/list').reply((config) => {
...
mock.onGet('/api/modules/user').reply((config) => {
...
// DELETE: Deletes User
mock.onDelete('/api/modules/users/delete').reply((config) => {
