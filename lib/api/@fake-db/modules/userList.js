...
// POST: Add new user
mock.onPost('/ui/modules/users/add-user').reply((config) => {
...
// GET: Updated DATA
mock.onGet('/ui/modules/users/list').reply((config) => {
...
mock.onGet('/ui/modules/user').reply((config) => {
...
// DELETE: Deletes User
mock.onDelete('/ui/modules/users/delete').reply((config) => {
