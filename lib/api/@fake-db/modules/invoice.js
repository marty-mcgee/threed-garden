...
// ------------------------------------------------
mock.onGet('/ui/modules/invoice/invoices').reply((config) => {
...
// ------------------------------------------------
mock.onGet('/ui/modules/invoice/single-invoice').reply((config) => {
  console.log('[MM] HEY HEY HEY DUDE DUDE DUDE !!! !!!')
...
// GET: Return Clients
// ------------------------------------------------
mock.onGet('/ui/modules/invoice/clients').reply(() => {
  console.log('[MM] HEY HEY HEY DUDE DUDE DUDE !!! !!!')
...
// ------------------------------------------------
mock.onDelete('/ui/modules/invoice/delete').reply((config) => {
  console.log('[MM] HEY HEY HEY DUDE DUDE DUDE !!! !!!')
