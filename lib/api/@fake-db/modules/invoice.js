...
// ------------------------------------------------
mock.onGet('/api/modules/invoice/invoices').reply((config) => {
  console.log('[MM] HEY HEY HEY DUDE DUDE DUDE !!! !!!')
...
// ------------------------------------------------
mock.onGet('/api/modules/invoice/single-invoice').reply((config) => {
  console.log('[MM] HEY HEY HEY DUDE DUDE DUDE !!! !!!')
...
// GET: Return Clients
// ------------------------------------------------
mock.onGet('/api/modules/invoice/clients').reply(() => {
  console.log('[MM] HEY HEY HEY DUDE DUDE DUDE !!! !!!')
...
// ------------------------------------------------
mock.onDelete('/api/modules/invoice/delete').reply((config) => {
  console.log('[MM] HEY HEY HEY DUDE DUDE DUDE !!! !!!')
