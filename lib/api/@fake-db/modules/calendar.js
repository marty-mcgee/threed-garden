...
// ------------------------------------------------
mock.onGet('/ui/modules/calendar/events').reply((config) => {
...
// POST: Add new event
// ------------------------------------------------
mock.onPost('/ui/modules/calendar/add-event').reply((config) => {
...
// POST: Update Event
// ------------------------------------------------
mock.onPost('/ui/modules/calendar/update-event').reply((config) => {
...
// DELETE: Remove Event
// ------------------------------------------------
mock.onDelete('/ui/modules/calendar/remove-event').reply((config) => {
