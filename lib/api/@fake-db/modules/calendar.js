...
// ------------------------------------------------
mock.onGet('/api/modules/calendar/events').reply((config) => {
...
// POST: Add new event
// ------------------------------------------------
mock.onPost('/api/modules/calendar/add-event').reply((config) => {
...
// POST: Update Event
// ------------------------------------------------
mock.onPost('/api/modules/calendar/update-event').reply((config) => {
...
// DELETE: Remove Event
// ------------------------------------------------
mock.onDelete('/api/modules/calendar/remove-event').reply((config) => {
