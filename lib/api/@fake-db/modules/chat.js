...
// ------------------------------------------------
mock.onGet('/ui/modules/chat/chats-and-contacts').reply(() => {
...
// ------------------------------------------------
mock.onGet('/ui/modules/chat/users/profile-user').reply(() => [200, data.profileUser])

// ------------------------------------------------
// GET: Return Single Chat
// ------------------------------------------------
mock.onGet('/ui/modules/chat/get-chat').reply((config) => {
...
// ------------------------------------------------
mock.onPost('/ui/modules/chat/send-msg').reply((config) => {
