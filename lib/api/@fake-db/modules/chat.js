...
// ------------------------------------------------
mock.onGet('/api/modules/chat/chats-and-contacts').reply(() => {
...
// ------------------------------------------------
mock.onGet('/api/modules/chat/users/profile-user').reply(() => [200, data.profileUser])

// ------------------------------------------------
// GET: Return Single Chat
// ------------------------------------------------
mock.onGet('/api/modules/chat/get-chat').reply((config) => {
...
// ------------------------------------------------
mock.onPost('/api/modules/chat/send-msg').reply((config) => {
