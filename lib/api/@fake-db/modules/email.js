...
// ------------------------------------------------
// GET: Return Emails
mock.onGet('/ui/modules/email/allEmails').reply(() => {
  return [200, { emails: data.emails }]
})

// ------------------------------------------------
// GET: Return Emails
mock.onGet('/ui/modules/email/emails').reply((config) => {
...
// ------------------------------------------------
mock.onPost('/ui/modules/email/update-emails-label').reply((config) => {
...
// ------------------------------------------------
mock.onGet('/ui/modules/email/get-email').reply((config) => {
...
// POST: Update Email
// ------------------------------------------------
mock.onPost('/ui/modules/email/update-emails').reply((config) => {
...
// ------------------------------------------------
mock.onGet('/ui/modules/email/paginate-email').reply((config) => {
