...
// ------------------------------------------------
mock.onGet('/modules/calendar/events').reply((config) => {
...
// POST: Add new event
// ------------------------------------------------
mock.onPost('/modules/calendar/add-event').reply((config) => {
...
// POST: Update Event
// ------------------------------------------------
mock.onPost('/modules/calendar/update-event').reply((config) => {
...
// DELETE: Remove Event
// ------------------------------------------------
mock.onDelete('/modules/calendar/remove-event').reply((config) => {
