...
// ------------------------------------------------
mock.onGet('/modules/chat/chats-and-contacts').reply(() => {
...
// ------------------------------------------------
mock.onGet('/modules/chat/users/profile-user').reply(() => [200, data.profileUser])

// ------------------------------------------------
// GET: Return Single Chat
// ------------------------------------------------
mock.onGet('/modules/chat/get-chat').reply((config) => {
...
// ------------------------------------------------
mock.onPost('/modules/chat/send-msg').reply((config) => {
