...
import ExampleComponent2 from '#/lib/threed/components/canvas/Box'

// R3F Shader (client side only) will now be 'dynamically' imported using Next, so it only loads on the client
import dynamic from 'next/dynamic'
// import Shader from '#/lib/threed/components/canvas/Shader/Shader'
...
const Shader = dynamic(() => import('#/lib/threed/components/canvas/Shader'), {
  ssr: false,
})
