...
const MMThreeDGardenWPPluginDemo = 'https://garden.university/wp-admin/admin.php?page=threedgarden'

const themeConfig = {
  // ** Layout Configs
  templateName: 'ThreeD Garden', // App Name
  MMThreeDGardenWPPluginDemo: MMThreeDGardenWPPluginDemo, // [MM] WordPress Plugin Demo Link
  layout: 'vertical', // vertical | horizontal
  mode: 'dark', // light | dark | blog
