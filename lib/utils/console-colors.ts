...
const ccm = {
  ...
  orangeAlert: 'color: white; font-size: 14px; font-weight: bold; background-color: orange;',
  yellow: 'color: yellow; font-size: 14px;',
  yellowAlert: 'color: white; font-size: 14px; font-weight: bold; background-color: yelow;',
