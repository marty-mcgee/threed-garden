...
const ccm = {
  ...
  orangeAlert: 'color: orange; font-size: 14px; font-weight: bold; background-color: black;',
  yellow: 'color: yellow; font-size: 14px;',
  yellowAlert: 'color: orange; font-size: 14px; font-weight: bold; background-color: black;',
