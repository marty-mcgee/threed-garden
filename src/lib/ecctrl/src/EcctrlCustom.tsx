...
const Ecctrl: ForwardRefRenderFunction<CustomEcctrlRigidBody, EcctrlProps> = ({
  ...
  fallingGravityScale = 25.0, // 2.5,
  fallingMaxVel = -200, // -20,
  wakeUpDelay = 200,
  // Floating Ray setups
  ...
  slopeRayOriginOffest = capsuleRadius - 30, // - 0.03,
  slopeRayLength = capsuleRadius + 300, // + 3,
  slopeRayDir = { x: 0, y: -1, z: 0 },
  slopeUpExtraForce = 1, // 0.1,
  slopeDownExtraForce = 2, // 0.2,
  ...
  bodySensorSize = [capsuleHalfHeight, capsuleRadius],
  bodySensorPosition = { x: 0, y: 0, z: capsuleRadius },
