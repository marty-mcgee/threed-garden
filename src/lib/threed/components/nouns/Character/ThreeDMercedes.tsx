// public\assets\mercedes\2002-mercedes-benz-e320-w210-4matic-sedan-fbx\source\FINAL_MODEL_02.fbx

// ** [MM] THREED CHARACTER -- FARMER; CAR;
...
export default function CharacterModel(props: any) {
  ...
  const modelFile = '/assets/mercedes/2002-mercedes-benz-e320-w210-4matic-sedan-fbx/source/FINAL_MODEL_02/FINAL_MODEL_02.fbx'
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (fbx) => {
        ...
        fbx.scale.set(12.5, 12.5, 12.5)     // Adjust scale as needed
        setModel(fbx)
      },
      undefined,
      (error) => {
