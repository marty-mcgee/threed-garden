        ...
        transform: function (matrix, _applyMatrix, _applyRecursively, _setApplyMatrix) {
          var _matrix = this._matrix,
            ...
            applyMatrix =
              ...
              (!_matrix.isIdentity() || transform || (_applyMatrix && _applyRecursively && this._children))
  ...
  Path.inject({
    statics: new (function () {
      ...
      return {
        Line: function () {
          return createPath(
            [new Segment(Point.readNamed(arguments, 'from')), new Segment(Point.readNamed(arguments, 'to'))],
            false,
            arguments
          )
        },
          ...
          for (var j = 0, l = chain.length; j < l; j++) {
            ...
            if (length <= curveLength) {
              ...
              var wind = !(
                operator.subtract &&
                path2 &&
                ((operand === path1 && path2._getWinding(pt, dir, true).winding) ||
                  (operand === path2 && !path1._getWinding(pt, dir, true).winding))
              )
      ...
      function emitMouseEvents(view, hitItem, type, event, point, prevPoint) {
        ...
        return (
          ...
          (hitItem &&
            ...
            emitMouseEvent(hitItem, null, type, event, point, prevPoint, dragItem)) ||
