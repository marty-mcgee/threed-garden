  ...
  return (
    <>
      ...
      <Menu
        ...
        <MenuItem sx={{ p: 0 }} onClick={() => handleDropdownClose('/api/modules/user/view/12')}>
          <Box sx={styles}>
            <AccountOutline sx={{ mr: 2 }} />
            Profile
          </Box>
        </MenuItem>
        <MenuItem sx={{ p: 0 }} onClick={() => handleDropdownClose('/api/modules/email')}>
          <Box sx={styles}>
            <EmailOutline sx={{ mr: 2 }} />
            Inbox
          </Box>
        </MenuItem>
        <MenuItem sx={{ p: 0 }} onClick={() => handleDropdownClose('/api/modules/chat')}>
          <Box sx={styles}>
