...
import Kanban from '#/app/modules/kanban/page'
import Wizard from '#/app/modules/wizard/page'
import DataTables from '#/app/modules/data-tables/page'
import Calendar from '#/app/modules/calendar/page'
