...
import Kanban from '#/pages/modules/kanban/page'
import Wizard from '#/pages/modules/wizard/page'
import DataTables from '#/pages/modules/data-tables/page'
import Calendar from '#/pages/modules/calendar/page'
