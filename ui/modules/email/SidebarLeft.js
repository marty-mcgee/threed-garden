    ...
    <Drawer
      ...
      <ScrollWrapper>
        <Box sx={{ pt: 0, overflowY: 'hidden' }}>
          <List component='div'>
            <Link href='/api/modules/email/inbox' passHref>
              <ListItemStyled
                component='span'
            ...
            <Link href='/api/modules/email/sent' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
            ...
            <Link href='/api/modules/email/draft' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
            ...
            <Link href='/api/modules/email/starred' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
            ...
            <Link href='/api/modules/email/spam' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
            ...
            <Link href='/api/modules/email/trash' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
          ...
          <List component='div'>
            <Link href='/api/modules/email/label/personal' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
            ...
            <Link href='/api/modules/email/label/company' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
            ...
            <Link href='/api/modules/email/label/important' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
            ...
            <Link href='/api/modules/email/label/private' passHref>
              <ListItemStyled
                component='span'
                onClick={handleListItemClick}
                sx={{
