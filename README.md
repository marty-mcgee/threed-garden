# [🥕 ThreeD Garden: WebGL 3D Environment on 'Next.JS React TypeScript Three.JS React-Three Physics', using Apollo GraphQL State+Stores, Leva Control GUI, Radix-UI, Material UI, Tailwind CSS, supporting 3D FarmBot React (Beta)](https://github.com/marty-mcgee/threed-garden/)
