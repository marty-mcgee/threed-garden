...
import configs from '#/pages/modules/calendar/components/ProductivityChart/config'
...
function ProductivityChart(): JSX.Element {
  ...
  const handleOpenMenu = ({ currentTarget }: { currentTarget: HTMLSpanElement }) => setOpenMenu(currentTarget)
