...
import About from '#/app/modules/wizard/components/About'
import Account from '#/app/modules/wizard/components/Account'
import Address from '#/app/modules/wizard/components/Address'
